...
Route::middleware('auth:sanctum')->post('/event/deleteEvent/{eventId}', [\App\Http\Controllers\EventController::class, 'deleteEvent'])->name("deleteEvent");
...
Route::middleware('auth:sanctum')->get('/link-preview', [LinkPreviewController::class, 'getLinkPreview'])->name("linkPreview");
/* Reaction */
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('currentUser', [ConversationController::class, 'getCurrentUser'] );
});
